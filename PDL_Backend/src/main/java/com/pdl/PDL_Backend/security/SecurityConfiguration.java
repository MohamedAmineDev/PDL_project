...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .requestMatchers("/api/category/admin/**", "/api/product/admin/**").hasAnyRole("ADMIN")
                .requestMatchers("/api/category/categories", "/api/product/products", "/api/product/products/**").hasAnyRole("CLIENT", "ADMIN")
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
